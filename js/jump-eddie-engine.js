...
var canvas, 
	ctx,
	velocidade = window.innerWidth/95, 
	estadoAtual, 
	record,
	carro,
	...
	player = new Image();
	player.src = "img/player_sprite.png";

	truck = new Image();
	truck.src = "img/truck.png";

	meioFioDi = new Image();
	meioFioDi.src = "img/meioFioDi.png";

	meioFioEs = new Image();
	meioFioEs.src = "img/meioFioEs.png";

	backRua = new Image();
	backRua.src = "img/backRua.png";
...
//Objetos Globais
	...
	bloco = {
		...
		qntPulos:0,
		score: 0,
		forcaDoPulo : window.innerHeight/90,
